...
import { DetailedWithdrawalRequest, WithdrawalRequestRepository } from '../withdrawal-request-repository'
...
export class PrismaWithdrawalRequestRepository implements WithdrawalRequestRepository {
  async create(data: Prisma.WithdrawalRequestCreateInput): Promise<DetailedWithdrawalRequest> {
    return prisma.withdrawalRequest.create({
      data,
      include: { applicant: { include: { profile: true } }, unit: true, transaction: true, userWhoActed: true }
    })
  }
